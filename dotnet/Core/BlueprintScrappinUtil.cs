...
namespace BlueprintScrappin.Util
{
    public static class BlueprintScrappinUtil
    {
        ...
        public static bool Falsy(object falsyable)
        {
            return
                ...
                (
                    ...
                    (
                        (falsyable is System.Boolean _System_Boolean && Truthy(_System_Boolean)) ||
        ...
        public static bool Truthy(System.Boolean truthyable)
        {
            return !truthyable;
        }

        public static bool Falsy(System.Boolean falsyable)
        {
            return falsyable;
        }
